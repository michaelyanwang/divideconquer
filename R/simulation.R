...
#'
#' \code{SIM.FUN} generates binary, count, and continuous-time survival response data that are associated with design matrix.
...
#' @return For binary and count data, it returns a matrix with the first column=response, rest = design matrix, without intercept.
